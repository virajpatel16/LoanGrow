...
public class Age_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_age_, container, false);
    ...
    private void addTableRow(String date, String dayOfWeek) {
        ...
        txtDate.setTextColor(requireContext().getColor(R.color.black));
        txtDate.setBackgroundColor(requireContext().getColor(R.color.appcolor)); // Set grid lines color
        tableRow.addView(txtDate);

        TextView txtDay = createTextView(dayOfWeek, Gravity.CENTER);
        txtDay.setTextColor(requireContext().getColor(R.color.black));
        txtDay.setBackgroundColor(requireContext().getColor(R.color.appcolor)); // Set grid lines color
    ...
    private void printTableHeader() {
        ...
        txtNo.setTextColor(requireContext().getColor(R.color.black));
        txtNo.setBackgroundColor(requireContext().getColor(R.color.appcolor)); // Set grid lines color
        tableRow.addView(txtNo);

        TextView txtPrincipal = createTextView("Day", Gravity.CENTER);
        txtPrincipal.setTextColor(requireContext().getColor(R.color.black));
        txtPrincipal.setBackgroundColor(requireContext().getColor(R.color.appcolor)); // Set grid lines color
    ...
    private TextView createTextView(String text, int gravity) {
        ...
        textView.setBackgroundColor(R.color.appcolor); // Set grid lines color
        return textView;
    }
