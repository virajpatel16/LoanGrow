...
public class Loan_Amount extends Fragment {

    private EditText edtMonthlyEmi, edtInterest, edtLoanTenure;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_loan__amount, container, false);
