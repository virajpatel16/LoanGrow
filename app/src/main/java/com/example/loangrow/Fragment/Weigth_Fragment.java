...
public class Weigth_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_weigth_, container, false);
    ...
    private void addResultRow(String unitLabel, double convertedWeight, int textColor) {
        ...
        unitTextView.setTextColor(Color.BLACK); // Set text color for unit TextView
        ...
        weightTextView.setTextColor(Color.BLACK); // Set text color for weight TextView
